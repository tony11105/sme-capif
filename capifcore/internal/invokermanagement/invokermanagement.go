...
func (im *InvokerManager) PostOnboardedInvokers(ctx echo.Context) error {
	...
	ApiInvokerCertificate := authenticator.GenerateRAppToken()
	// log.Println(ApiInvokerCertificate)
	*newInvoker.OnboardingInformation.ApiInvokerCertificate = ApiInvokerCertificate
	log.Println(*newInvoker.OnboardingInformation.ApiInvokerCertificate)
